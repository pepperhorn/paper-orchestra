...
export default function PaperSequencer() {
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center gap-4 text-text-primary"
      ...
      <div className="w-3 h-3 rounded-full" style={{ background: '#9090d0', boxShadow: '0 0 12px #9090d0' }} />
      <h1 className="text-2xl tracking-[0.18em] text-accent uppercase">Paper Sequencer</h1>
      <p className="text-text-muted text-sm">Grid-based pattern sequencer</p>
