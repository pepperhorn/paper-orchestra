...
export default function PaperGuitar() {
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center gap-4 text-text-primary"
      ...
      <div className="w-3 h-3 rounded-full bg-success" style={{ boxShadow: '0 0 12px #7abe8a' }} />
      <h1 className="text-2xl tracking-[0.18em] text-accent uppercase">Paper Guitar</h1>
      <p className="text-text-muted text-sm">Strum detection on printed fretboard</p>
