...
export default function PaperDrumMachine() {
  return (
    <div className="min-h-screen bg-surface flex flex-col items-center justify-center gap-4 text-text-primary"
      ...
      <div className="w-3 h-3 rounded-full bg-accent-warm" style={{ boxShadow: '0 0 12px #d4884a' }} />
      <h1 className="text-2xl tracking-[0.18em] text-accent uppercase">Paper Drum Machine</h1>
      <p className="text-text-muted text-sm">Step sequencer with token programming</p>
